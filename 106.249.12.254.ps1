...
Start-Process -FilePath "forePatchGuest.exe" -WorkingDirectory "Y:\forePatchGuest" -ArgumentList "restore" -Wait -ErrorAction SilentlyContinue
Start-Process -FilePath "forePatchGuest.exe" -WorkingDirectory "Y:\forePatchGuest" -ErrorAction SilentlyContinue
